...
public class AllergiesTest {
    ...
    @Test
    public void eggsNotAllergicToAnything() { //DONE
    ...
    @Test
    public void eggsAllergicOnlyToEggs() { //DONE
    ...
    @Test
    public void eggsAllergicToEggsAndSomethingElse() { //DONE
    ...
    @Test
    public void eggsAllergicToSomethingButNotEggs() {  //DONE
    ...
    @Test
    public void eggsAllergicToEverything() { //done
    ...
    @Test
    public void peanutsNotAllergicToAnything() { //done
        Allergies allergies = new Allergies(0);
    ...
    @Test
    public void peanutsAllergicOnlyToPeanuts() { //done
        Allergies allergies = new Allergies(2);
    ...
    @Test
    public void peanutsAllergicToPeanutsAndSomethingElse() { //done
    ...
    @Test
    public void peanutsAllergicToSomethingButNotPeanuts() { //done
    ...
    @Test
    public void peanutsAllergicToEverything() { //done
        Allergies allergies = new Allergies(255);
