...
public class HandshakeCalculatorTest {
    ...
    public void testThatInput1YieldsAWink() {
        assertEquals(
                ...
                handshakeCalculator.calculateHandshake(1));  //1
    }
    ...
    public void testThatInput2YieldsADoubleBlink() {
        assertEquals(
                ...
                handshakeCalculator.calculateHandshake(2)); //10
    }
    ...
    public void testThatInput4YieldsACloseYourEyes() {
        assertEquals(
                ...
                handshakeCalculator.calculateHandshake(4)); //100
    }
    ...
    public void testThatInput8YieldsAJump() {
        assertEquals(
               ...
               handshakeCalculator.calculateHandshake(8)); //1000
    }
    ...
    public void testAnInputThatYieldsTwoActions() {
        assertEquals(
                ...
                handshakeCalculator.calculateHandshake(3)); //11
    }
    ...
    public void testAnInputThatYieldsTwoReversedActions() {
        assertEquals(
               ...
               handshakeCalculator.calculateHandshake(19)); //10011
    }
    ...
    public void testReversingASingleActionYieldsTheSameAction() {
        assertEquals(
                singletonList(Signal.JUMP),
                handshakeCalculator.calculateHandshake(24)); //11000
    }
    ...
    public void testReversingNoActionsYieldsNoActions() {
        assertEquals(
                emptyList(),
                handshakeCalculator.calculateHandshake(16)); //1000
    }
    ...
    public void testInputThatYieldsAllActions() {
        assertEquals(
                ...
                handshakeCalculator.calculateHandshake(15)); //1111
    }
    ...
    public void testInputThatYieldsAllActionsReversed() {
        assertEquals(
                ...
                handshakeCalculator.calculateHandshake(31));  //11111
    }
    ...
    public void testThatInput0YieldsNoActions() {
        assertEquals(
                emptyList(),
                handshakeCalculator.calculateHandshake(0));  //0
    }
