...
public class SeriesTest {
    ...
    @Test
    public void slicesOfOneFromOne() { //done
    ...
    @Test
    public void slicesOfOneFromTwo() { //done
    ...
    @Test
    public void slicesOfTwoOverlap() { //done
    ...
    @Test
    public void slicesIncludeDuplicates() { //done
    ...
    @Test
    public void slicesOfLongSeries() { //done
    ...
    @Test
    public void sliceLengthIsToolarge() { //done
    ...
    @Test
    public void sliceLengthZero() { //done
        expectedException.expect(IllegalArgumentException.class);
    ...
    @Test
    public void sliceLengthNegative() { //done
        expectedException.expect(IllegalArgumentException.class);
        expectedException.expectMessage("Slice size is too small.");
