...
public class ProverbTest {
    ...
    @Test
    public void zeroWordsAreGiven() { //done
    ...
    @Test
    public void singlePieceOfProverb() { //done
    ...
    @Test
    public void twoPiecesOfProverb() { //done
    ...
    @Test
    public void shortChainOfConsequences() { //done
    ...
    @Test
    public void fourPiecesModernizedProverb() { //done
