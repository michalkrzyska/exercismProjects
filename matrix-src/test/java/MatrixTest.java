...
public class MatrixTest {
    ...
    @Test
    public void extractRowFromDiffWidthsMatrixTest() { //done
        String matrixAsString = "1 2\n10 20";
        int rowIndex = 2;
    ...
    @Test
    public void extractRowFromNonSquareMatrixTest() { //done
    ...
    @Test
    public void extractColumnFromOneNumberMatrixTest() { //done
        String matrixAsString = "1";
        int columnIndex = 1;
    ...
    @Test
    public void extractColumnMatrixTest() { //done
        String matrixAsString = "1 2 3\n4 5 6\n7 8 9";
        int columnIndex = 3;
    ...
    @Test
    public void extractColumnFromNonSquareMatrixTest() { //done
    ...
    @Test
    public void extractColumnFromDiffWidthsMatrixTest() { //done
